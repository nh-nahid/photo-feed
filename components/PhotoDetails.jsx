    ...
    return (
        <div className="grid grid-cols-12 gap-4 2xl:gap-10 ">
            <div className="col-span-12 lg:col-span-8 border rounded-xl">
                <Image className="max-w-full h-full max-h-[70vh] mx-auto" width={900} height={500} src={photo.url} alt={photo.title} />
            </div>
                ...
                <div className="mt-6">
                    <div className="flex justify-between items-center mb-3">
                        <div className="flex items-center gap-3">
                            <Image className="size-12 lg:size-14 rounded-full border" src={photo.author.avatar} alt="avatar" width={50} height={50}/>
                        ...
                        <button className="flex items-center gap-1.5 text-black/60 text-xs xl:text-sm">
                            <Image src={'/follow.svg'} width={50} height={50} className="w-5 h-5" />
                            {dictionary.follow}
                        </button>
                    </div>
                ...
                <div className="mt-6">
                    <div className="flex items-stretch gap-3">
                        <button
                            ...
                            <Image src={"/heart.svg"} width={50} height={50} className="w-5 h-5" />
                            {photo.likes}
                        </button>
                        <button
                            className="flex-1 border py-1.5 rounded text-xs lg:text-sm flex items-center justify-center text-center gap-1.5 font-bold hover:bg-yellow-400">
                            <img src={"/save.svg"} width={50} height={50} className="w-5 h-5" />
                            {dictionary.save}
                        </button>
                        <button
                            className="flex-1 border py-1.5 rounded text-xs lg:text-sm flex items-center justify-center text-center gap-1.5 font-bold hover:bg-yellow-400">
                            <Image src={"/share.svg"} width={50} height={50} className="w-5 h-5" />
